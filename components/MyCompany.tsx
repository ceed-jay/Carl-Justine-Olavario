      ...
      <MacWindow title="My Company - HQ">
        <div className="flex flex-col items-center text-center">
            <ScrollReveal>
                ...
                />
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">PIXODE Development</h2>
                <p className="text-md sm:text-lg text-blue-500 font-semibold">Your Vision, Our Code, One Digital World</p>
            </ScrollReveal>
            <ScrollReveal>
                <p className="mt-4 max-w-2xl text-gray-700 text-justify">
            ...
            <ScrollReveal>
                <h3 className="text-xl sm:text-2xl font-bold mt-8 mb-4 text-gray-800">Our Services</h3>
                <ul className="space-y-2 text-left mx-auto max-w-md text-gray-700">
