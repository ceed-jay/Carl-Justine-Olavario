      ...
      <MacWindow title="About Me - Finder">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="lg:w-2/3 text-center lg:text-left">
             <ScrollReveal>
                <h1 className="text-4xl md:text-5xl font-extrabold mb-2">Carl Justine B. Olavario</h1>
                <p className="text-xl md:text-2xl font-semibold mb-6 text-blue-500 dark:text-blue-400">Junior Game & Web Full stack Developer</p>
            </ScrollReveal>
            <ScrollReveal>
                <p className="text-base mb-4 text-gray-700 dark:text-gray-300 text-justify">
